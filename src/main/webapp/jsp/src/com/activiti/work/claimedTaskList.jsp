...
<script type="text/javascript">
		...
		function doQuery(){
			...
			$.ajax({
		 		type: "post",
		 		url: basePath+"/activiti/claimedTaskList",
		 		data:params,
		 		async: false,
		 		dataType: "text",
		 		success: function(data){
		 			...
		 			var sb = new StringBuilder();
		               $.each(das.obj.rows,function(i,obj){ 
						 ...
						 sb.append("<td >").append(obj.createTime,25).append("</td>");
						 sb.append("<td >").append(obj.description,15).append("</td>");
						 sb.append("<td ><a class='hj_mar20' onclick='start(\"").append(obj.taskId).append("\");'><i class='icon icon-pencil hj_bianji'></i><span class='hj_mar20'>启动流程</span></a>");
						 sb.append("<a class='hj_mar20' onclick='selectImg(\"").append(obj.processInstanceId).append("\")'><i class='icon icon-search hj_bianji'></i><span class='hj_mar20'>查看流程图</span></a>");
						sb.append("<a class='hj_mar20' onclick='del(\"").append(obj.taskId).append("\");'><i class='icon icon-remove-sign hj_delete'></i><span class='hj_mar20'>删除</span></a></tr>");
			  			}); 
		 			 $("#tb").html(sb.toString());	 			 
		 		}
 			});
		...
		function selectImg(id){
			layer.open({
			  ...
			  offset: '5%',
			  area: ['90%', '90%'],
			  content: "${base}/jsp/src/com/activiti/work/activitiImage.jsp?type=ru&id="+id,//此处id为流程实例id
			  end: function () {
				}
			}); 
		}
