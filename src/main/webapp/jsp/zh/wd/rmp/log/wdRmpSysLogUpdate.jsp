...
<script type="text/javascript" src="js/wdRmpSysLogUpdate.js"></script>
<link rel="stylesheet" type="text/css" href="css/wdRmpSysLogUpdate.css">
...
<script type="text/javascript">
		...
		function doQuery(){
			$.ajax({
		 		type: "get",
		 		url: "<%=basePath%>/wdRmpSysLog/selectByPrimaryKey",
		 		data:{
		 			"id":"<%=id%>"
		 		},
		 		async: true,
		...
		function Submit() {
			...
			$.ajax({
		 		type: "post",
		 		url: "<%=basePath%>/wdRmpSysLog/update",
		 		data:params,
		 		async: true,
		 		dataType: "text",
		 		beforeSend: function(){},  
	        	complete: function(){},
		 		success: function(data){
		 			var das = JSON.parse(data);
		 			if(das.success){
		 				location.href=basePath + "/static/commons/massage/success.jsp?url="+basePath+"/jsp/zh/wd/rmp/log/wdRmpSysLogList.jsp";
		 			}else{
		 				location.href=basePath + "/static/commons/massage/failure.jsp?url="+basePath+"/jsp/zh/wd/rmp/log/wdRmpSysLogList.jsp";
		 			}
		 		}
 			});
		}
		...
		function back() {
			location.href=basePath + "/jsp/zh/wd/rmp/log/wdRmpSysLogList.jsp";
		}
	</script>
</html>