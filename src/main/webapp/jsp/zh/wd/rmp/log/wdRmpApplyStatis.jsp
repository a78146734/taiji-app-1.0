...
<script type="text/javascript">
		...
		function selectchild(pid){
			location.href=basePath+"/appAnalysis/applyFuncStatis?pid="+pid;
		}
		...
		function graphQuery(){
			 ...
			 $.ajax({
		 		type: "post",
		 		url: basePath+"/appAnalysis/totalApply",
				data:{"modular":"1"},
		 		async: false,
		 		dataType: "json",  //text
		 		beforeSend: function(){},
		...
		//			            }
			 ...
			 $.ajax({
			 		type: "post",
			 		url: basePath+"/appAnalysis/applyPassRate",
					data:{"modular":"1"},	 
			 		async: false,
			 		dataType: "json",  //text
			 		beforeSend: function(){},
		...
		//	 pieData2.push("其他");
			// pieSeriesData2.push({value:0,name:"其他"});
			 $.ajax({
		 		type: "post",
		 		url: basePath+"/appAnalysis/systemApply",
				data:{"modular":"1"},
		 		async: false,
		 		dataType: "json",  //text
		 		beforeSend: function(){},
		...
		//			            }
			 ...
			 $.ajax({
			 		type: "post",
			 		url: basePath+"/appAnalysis/systemPassRate",
					data:{"modular":"1"},	 
			 		async: false,
			 		dataType: "json",  //text
			 		beforeSend: function(){},
