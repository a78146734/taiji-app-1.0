...
<script type="text/javascript" src="js/wdRmpSysErrorLogUpdate.js"></script>
<link rel="stylesheet" type="text/css" href="css/wdRmpSysErrorLogUpdate.css">
...
<script type="text/javascript">
		...
		function doQuery(){
			...
			sb.append("<tr><td class='tablecolor'>被访问方法：").append("</td><td  ><input type='text' name='logMethod'  value='").append(das.obj.logMethod).append("' ></td>");
						...
						sb.append("<td  class='tablecolor'>参数：</td><td ><input type='text' name='logParameter'  value='").append(das.obj.logParameter).append("' ></td></tr>");
		...
		function Submit() {
			...
			$.ajax({
		 		type: "post",
		 		url: "<%=basePath%>/wdRmpSysErrorLog/update",
		 		data:params,
		 		async: true,
		 		dataType: "text",
		 		beforeSend: function(){},  
