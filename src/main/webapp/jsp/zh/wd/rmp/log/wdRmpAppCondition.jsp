			...
			<div class="hj_user">
				 <table class="gridtable03">
					<tr>
						...
						<th style="width: 18%;"><a id="SERVER_PURPOSE" class="tha"
							onclick="sort(this);"><span>服务用途</span><i class="thimg"></i></a></th>
...
<script type="text/javascript">
	...
	//		doQuery();
		...
		function doQuery(){
			...
			$.ajax({
		 		type: "post",
		 		url: basePath+"/wdRmpAppServiceLog/serviceInfo",
		 		data:params,
		 		async: false,
		 		dataType: "text",
		 		success: function(data){
		 			...
		 			var sb = new StringBuilder();
		              $.each(das.obj.rows,function(i,map){ 
		 				 ...
		 				 sb.append("<td >").append(map["SERVER_PURPOSE"],15).append("</td>");
		 		 		 sb.append("<td >");
		...
		function selectchild(pid){
			location.href=basePath+"/appAnalysis/appFuncCondition?pid="+pid;
		}
		...
		function selectPService(){
			 $.ajax({
			 		type: "post",
			 		url: basePath+"/appAnalysis/selectPService",
					data:[],	 
			 		async: false,
			 		dataType: "json",  //text
			 		beforeSend: function(){},
		...
		function graphQuery(){
			 ...
			 $.ajax({
			 		type: "post",
			 		url: basePath+"/appAnalysis/invokeTime",
					data:[],	 
			 		async: false,
			 		dataType: "json",  //text
			 		beforeSend: function(){},
		...
		function graphQuery2(){
			 var option2 = {
				...
				var markPoint = {
				 ...
				 $.ajax({
				 		type: "post",
				 		url: basePath+"/appAnalysis/serviceInvokeTime",//serviceInvokeTimeMonthly
						data:{"pid":pIds},	 
				 		async: false,
				 		dataType: "json",  //text
				 		beforeSend: function(){},
		...
		function graphQuery3(){
			 var option2 = {
				...
				var markPoint = {
				 ...
				 $.ajax({
				 		type: "post",
				 		url: basePath+"/appAnalysis/serviceInvokeTimeMonthly", 
						data:{"pid":pIds},	 
				 		async: false,
				 		dataType: "json",  //text
				 		beforeSend: function(){},
		...
		function graphQuery4(){
			 ...
			 var option3 = {
				...
				var markPoint = {
				 ...
				 $.ajax({
				 		type: "post",
				 		url: basePath+"/appAnalysis/systemInvokeTime",
						data:{"sysIP":sysIPs},	 
				 		async: false,
				 		dataType: "json",  //text
				 		beforeSend: function(){},
		...
		function graphQuery5(){
			 ...
			 var option3 = {
				...
				var markPoint = {
				 ...
				 $.ajax({
				 		type: "post",
				 		url: basePath+"/appAnalysis/systemInvokeTimeMonthly",
						data:{"sysIP":sysIPs},	 
				 		async: false,
				 		dataType: "json",  //text
				 		beforeSend: function(){},
