...
<script type="text/javascript" src="js/wdRmpSysLogDetail.js"></script>
<link rel="stylesheet" type="text/css" href="css/wdRmpSysLogDetail.css">
...
<script type="text/javascript">
		...
		function doQuery(){
			...
			sb.append("<tr><td class='tablecolor'>日志级别：").append("</td><td  >").append(das.obj.logLevel).append("</td>");
						...
						sb.append("<td  class='tablecolor'>模块名称：</td><td >").append(das.obj.logModular).append("</td></tr>");
			...
			sb.append("<tr><td class='tablecolor'>功能名称：").append("</td><td  >").append(das.obj.logFunction).append("</td>");
						...
						sb.append("<td  class='tablecolor'>操作类型：</td><td >").append(das.obj.operatType).append("</td></tr>");
					 						 					 						 				    
		 				
			sb.append("<tr><td class='tablecolor'>备注信息：").append("</td><td  >").append(das.obj.logMessage).append("</td>");
