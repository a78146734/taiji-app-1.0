...
<!-- <script type="text/javascript" src="js/wdRmpAppServiceLogDetail.js"></script>
<link rel="stylesheet" type="text/css" href="css/wdRmpAppServiceLogDetail.css"> -->
...
<script type="text/javascript">
		...
		function doQuery(){
			...
			sb.append("<tr><td class='tablecolor'>日志级别：").append("</td><td  >").append(das.obj.logLevel).append("</td>");
						...
						sb.append("<td  class='tablecolor'>子服务标识：</td><td >").append(das.obj.logService).append("</td></tr>");
					 						 					 						 				    
		 				
			sb.append("<tr><td class='tablecolor'>子服务路径：").append("</td><td  >").append(das.obj.logServicePath).append("</td>");
			
					 						 					 						 				    
		 				
						sb.append("<td  class='tablecolor'>子服务名称：</td><td >").append(das.obj.logServiceName).append("</td></tr>");
