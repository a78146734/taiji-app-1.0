	 		...
	 		success: function(data){		 			  
	 			...
	 			treeObj2.expandAll(true);	 				
	  			  	$.ajax({
	 					...
	 					//alert("id length: "+data2.obj.length);
...
/* 	function searchOrg(){	 
		$.ajax({
	 		...
	 		success: function(data){
	 				...
	 				treeObj.expandAll(true);
	 			  	...
	 			  	$.ajax({
	 			 		type: "post",
	 			 		url: "${base}/organization/resourceIds",
	 			 		data: {"organId":'${id}'},
	 			 		async: true,
	 			 		dataType: "json",
	 			 		success: function(data2){	 		
	...
	function Grant(){
          ...
          var nodes2=treeObj2.getCheckedNodes(true);
           ...
           $.ajax({
	 		type: "post",
	 		url: "${base}/organization/grant",
	 		data: {"id":"${id}","purIds":purIds},
	 		async: true,
	 		dataType: "json",
	 		success: function(data){
	 			if(data.success)
	...
	function showCheckTree(){			
		$("#treeDemo").empty();		
		var treeObjShow=treeObj2.getCheckedNodes(true);
		var rIds="";
	...
	function showAjax(obj){
		$.ajax({
	 		...
	 		dataType: "json",
	 		success: function(data){	 			  
 				var treeObjDemo2 = $.fn.zTree.init($("#treeDemo"), setting, data);
...
<BODY>
	...
	<div class="content_wrap" style="width: 100%;">
		...
		<div  style="text-align: center; padding: 9px 19px">
			<button onclick="Grant();" class="button" type="button">提交</button>
