...
%>
	<script type="text/javascript"  src="../../static/commons/page/js/basecontrol.js" charset="utf-8"></script>
    ...
    <table cellpadding="0" cellspacing="0" class="fenye-tab" style="overflow: hidden;">
          <tr>
          <td id="page1" nowrap>
          	<a href="#" onClick="javascript:jump('first',this);return false;"><img src="<%=basePath2%>/static/commons/page/images/f1.gif" /></a>&nbsp;&nbsp;&nbsp;
          </td>
          <td id="noPage1" style="display:none;">
          	<a><img src="<%=basePath2%>/static/commons/page/images/left-img1no.png" /></a>
          </td>
          <td id="page2" nowrap>
			<a href="#" onClick="javascript:jump('pre',this);return false;"><img src="<%=basePath2%>/static/commons/page/images/f4.gif" /></a>&nbsp;&nbsp;&nbsp;
		  </td>
		  ...
		  <td id="page3" nowrap>
			<a href="#" onClick="javascript:jump('next',this);return false;"><img src="<%=basePath2%>/static/commons/page/images/f3.gif" /></a>&nbsp;&nbsp;&nbsp;
          </td>
		  <td id="noPage3" style="display:none;">
			<a href="javascript:void(0);" ><img src="<%=basePath2%>/static/commons/page/images/left-img3no.png" /></a>
          </td>
          <td id="page4" nowrap>
          	<a href="#" onClick="javascript:jump('end',this);return false;"><img src="<%=basePath2%>/static/commons/page/images/f2.gif" ></a>&nbsp;&nbsp;&nbsp;
          </td>
          <td id="noPage4" style="display:none;">
          	<a href="javascript:void(0);" ><img src="<%=basePath2%>/static/commons/page/images/left-img4no.png" ></a>
          </td>
          
       <td style="width:107px">共<label id="totalRecordSpan"></label>条记录</td>
       <td><label id="nowpageSpan"></label>/<label id="totalpageSpan"></label></td>
         </tr>
         </table>
...
<input type=hidden name=pagesize value="10"><!-- 每页记录数 -->
