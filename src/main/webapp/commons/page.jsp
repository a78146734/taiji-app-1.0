...
%>
	<script type="text/javascript"  src="<%=basePath1%>/static/commons/page/js/basecontrol.js" charset="utf-8"></script>
    ...
    <table cellpadding="0" cellspacing="0" class="fenye-tab" style="overflow: hidden;">
          ...
          <td id="noPage1" style="display:none;">
          	<a><%-- <img src="<%=basePath1%>/static/commons/page/images/left-img1no.png" /> --%></a>
          </td>
          <td id="page2">
          ...
          <td id="noPage2" style="display:none;">
			<a href="javascript:void(0);" ><%-- <img src="<%=basePath1%>/static/commons/page/images/left-img2no.png" /> --%></a>
		  </td>
		  <td id="page3">
			<a href="javascript:void(0);" onClick="javascript:jump('next',this);return false;">下一页</a>&nbsp;&nbsp;&nbsp;
          </td>
		  <td id="noPage3" style="display:none;">
			<a href="javascript:void(0);" ><%-- <img src="<%=basePath1%>/static/commons/page/images/left-img3no.png" /> --%></a>
          </td>
          <td id="page4">
          	<a href="javascript:void(0);" onClick="javascript:jump('end',this);return false;">末页</a>&nbsp;&nbsp;&nbsp;
          </td>
          <td id="noPage4" style="display:none;">
          	<a href="javascript:void(0);" ><%-- <img src="<%=basePath1%>/static/commons/page/images/left-img4no.png" > --%></a>
          </td>
          <td style="width:44px;">
